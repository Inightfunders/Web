      ...
      <div className="py-[40px] px-[32px]">
        ...
        <div className="flex gap-4 pb-6  flex-col md:flex-row">
          <input
            ...
            value={referralLink}
            readOnly
            className="w-full py-3 px-4 text-xs !border !border-[#EAEAEA] rounded-[8px] bg-transparent"
          />
          <button
            type="button"
            onClick={handleCopy}
            className="flex rounded-[8px] w-[100px] sm:w-[90px] md:w-[130px] lg:w-[140px] xl:w-[150px] justify-center items-center gap-2 bg-[#FF7A00] text-white px-4 py-3"
          >
            <img src="/images/copy.svg" alt="Copy icon" className="w-4 md:w-6" />
