      ...
      {submitted ? (
        <div className="flex flex-col items-center justify-center gap-8 mt-24">
          <div className="flex flex-col items-center justify-center gap-4">
            <h1 className="text-2xl font-bold font-Montserrat text-white text-center">
              Check your email
            </h1>
            <h2 className="text-base text-center font-normal text-white">
              We sent a password reset link to <br /> {email}
            </h2>
          </div>
          <p className="text-white font-normal text-sm font-Montserrat mx-auto">
            Didn't receive the email?{' '}
            <span
              onMouseDown={() => handleSubmit()}
              className="text-[#FF7A00] underline cursor-pointer font-normal"
            >
              Resend
            </span>
          </p>
