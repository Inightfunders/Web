  ...
  return (
    <>
      <div
        ...
        className="flex-1 bg-[#EAEAEA] w-full cursor-pointer h-full flex flex-col items-center justify-center"
      >
        <p className="p-[22px] whitespace-nowrap font-Montserrat text-[13px]">
          {name}
        </p>
      </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-base font-bold">
                {investor.investor_type === "Individual"
                  ? "Individual"
                  : investor.institution_type ?? "Individual"}
              </p>
            </div>
          </div>
        </DialogContent>
